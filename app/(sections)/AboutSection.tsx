      ...
      <div className="w flex justify-center gap-16">
        <div className="flex flex-col gap-7">
          <p className="font-spartan font-bold">
            Hey! Thanks for scrolling this far :) I graduated from Monash
            University with a double bachelor of computer science 🖥️ and finance
            💸. I&#39;ve also completed a full-stack bootcamp with a great
            open-source community (you might&#39;ve heard of it) The Odin
            Project.
          </p>
          <p className="font-spartan font-bold">
          ...
          <p className="font-spartan font-bold">
            ...
            Currently, I&#39;m into books and baking. Although I do want to pick
            up an artsy/crafty hobby. Feel free to reach out to me if you have
            any suggestions!
          </p>
        </div>
